...
//             <span className="bg-[#E85744] text-white p-2 rounded">Secure</span>{" "}
//             your cloud.
//             <br />
...
//         </div>
//       </div>
//       <div className="sm:px-6 lg:py-14 max-w-7xl mx-auto px-4 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 py-8 sm:py-12 px-4 sm:px-8 lg:px-12 rounded-2xl bg-[var(--color-neutral-3)] border border-gray-100 shadow-lg">
          <div className="flex flex-col gap-4 sm:gap-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              <Button
                variant="outline"
                className="border border-black/10 w-fit"
              >
                Contact us
              </Button>
            </div>
